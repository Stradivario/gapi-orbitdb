...
export declare type OrbitDBEvents = 'replicated' | 'replicate' | 'replicate.progress' | 'load' | 'load.progress' | 'ready' | 'write';
...
export declare const OrbitDb: InjectionToken<OrbitDb>;
